...
if($flag==1)
{
  $prod=$peread-$psread;
  $type=$ptype;
  $sql3="UPDATE loomtable SET production=production + $prod, $type= $type + $prod WHERE loomno=$ploomno ";
...
<body>
  ...
  <a href=loomno.html>Loom</a>  
  <a href=res.html>Result</a>
</div>

<div class="main">
  <h1>     LOOM MANAGMENT </h1><BR>
<form method="POST" action="loom.php">
 ...
 <div class="userinput">
   <label> LOOM_No : </label>   
   <input id="A" type="number" name="loomno" value="<?php echo $ploomno; ?>" placeholder="<?php echo $ploomno; ?>" required>
  </div>
